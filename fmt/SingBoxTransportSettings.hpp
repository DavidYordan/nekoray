...
namespace NekoGui_fmt {
    class SingBoxTransportSettings : public JsonStore {
    public:
        QString network = "tcp";
        QString security = "";
        ...
        SingBoxTransportSettings() : JsonStore() {
    ...
    inline SingBoxTransportSettings *GetStreamSettings(AbstractBean *bean) {
        ...
        if (stream_item != nullptr) {
            ...
            auto stream = (NekoGui_fmt::SingBoxTransportSettings *) stream_store;
            return stream;
        }
        return nullptr;
    }
