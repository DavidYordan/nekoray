...
require github.com/sagernet/sing v0.8.10
...
replace github.com/anytls/sing-anytls => ../../../third_party/routefluent-sing-box/work/src/sing-anytls-0.0.11-routefluent-client
