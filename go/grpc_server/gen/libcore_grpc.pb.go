...
type LibcoreServiceClient interface {
	...
	GetDaemonInfo(ctx context.Context, in *EmptyReq, opts ...grpc.CallOption) (*DaemonInfoResp, error)
	ReconcileLifecycle(ctx context.Context, in *LifecycleReconcileReq, opts ...grpc.CallOption) (*LifecycleStateResp, error)
...
func (c *libcoreServiceClient) GetDaemonInfo(ctx context.Context, in *EmptyReq, opts ...grpc.CallOption) (*DaemonInfoResp, error) {
	out := new(DaemonInfoResp)
	err := c.cc.Invoke(ctx, "/libcore.LibcoreService/GetDaemonInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *libcoreServiceClient) ReconcileLifecycle(ctx context.Context, in *LifecycleReconcileReq, opts ...grpc.CallOption) (*LifecycleStateResp, error) {
	out := new(LifecycleStateResp)
	err := c.cc.Invoke(ctx, "/libcore.LibcoreService/ReconcileLifecycle", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LibcoreServiceServer interface {
	...
	GetDaemonInfo(context.Context, *EmptyReq) (*DaemonInfoResp, error)
	ReconcileLifecycle(context.Context, *LifecycleReconcileReq) (*LifecycleStateResp, error)
...
func (UnimplementedLibcoreServiceServer) GetDaemonInfo(context.Context, *EmptyReq) (*DaemonInfoResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetDaemonInfo not implemented")
}
func (UnimplementedLibcoreServiceServer) ReconcileLifecycle(context.Context, *LifecycleReconcileReq) (*LifecycleStateResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ReconcileLifecycle not implemented")
}
...
func _LibcoreService_GetDaemonInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EmptyReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LibcoreServiceServer).GetDaemonInfo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/libcore.LibcoreService/GetDaemonInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LibcoreServiceServer).GetDaemonInfo(ctx, req.(*EmptyReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _LibcoreService_ReconcileLifecycle_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(LifecycleReconcileReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LibcoreServiceServer).ReconcileLifecycle(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/libcore.LibcoreService/ReconcileLifecycle",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LibcoreServiceServer).ReconcileLifecycle(ctx, req.(*LifecycleReconcileReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var LibcoreService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _LibcoreService_GetDaemonInfo_Handler,
		},
		{
			MethodName: "ReconcileLifecycle",
			Handler:    _LibcoreService_ReconcileLifecycle_Handler,
		},
		{
			MethodName: "Test",
