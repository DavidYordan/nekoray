...
CTest 当前包含 1 项 `config_recovery_test`，验证覆盖备份、隔离证据、删除前快照，以及事务提交/模拟回滚/锁/pending 检测；这不代表订阅和非空 group 已完成事务化，也不代表 ConfigBuilder、导入、GUI、TUN/WFP 或系统代理已有 C++ 自动验收。发布前还必须完成 [测试矩阵](../testing/TEST_MATRIX.md)。
